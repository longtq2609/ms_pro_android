package com.example.ms_pro.base.view.alerter;
 ...
 * all other views. It should appear under the status pressure.
 *
 * @author Kevin Murphy
 * @since 03/11/2015.
 */
public final class Alerter {
    ...
    /**
     * Enable or disable progress pressure
     *
     * @param enable True to enable, False to disable
     * @return This Alerter
     */
    ...
    /**
     * Set the Progress pressure color from a color resource
     *
