...
//        TransitionSet mSet = getField(mAnimationHelper.getClass(), mAnimationHelper, "mSet");
        TransitionSet mSet = getField(mMenuView.getClass(), mMenuView, "set");
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
    ...
    /**
     * get the current selectable item position
     *
    ...
    public int getCurrentItem() {
        ...
        private BottomNavigationItemView[] mButtons;
        3. get menu and traverse it to get the selectable one
         */
...
//        BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
    ...
    /**
     * set the current selectable item
     *
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * Large one will be shown when item selectable.
     *
     * @param sp
     */
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager, boolean smoothScroll) {
        ...
        // Now we'll save a navigation item selected listener to set ViewPager's current item
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
            ...
            // replaceValue previous position
